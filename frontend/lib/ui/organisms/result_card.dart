...
class ResultCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final vehicleLabel = record.vehicleType == 'moto'
        ? 'Motocicleta'
        : record.vehicleType == 'bici'
        ? 'Bicicleta'
        : 'Automóvil';
    final vehicleIcon = record.vehicleType == 'carro'
        ? LucideIcons.car
        : LucideIcons.bike;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Row(
              children: [
                ...
                GridItem(
                  ...
                  isMono: true,
                  headerAccessory:
                      (showVehicleEditInHeader && onEditVehicleInHeader != null)
                      ? InkWell(
                ...
                GridItem(
                  ...
                  label: 'Casco',
                  valueText: record.hasHelmet
                      ? 'Sí (${record.helmetCount})'
                      : 'No',
          ...
          if (record.vehicleDescription != null ||
              record.vehiclePhotoUrl != null ||
              (record.hasHelmet && record.helmets.isNotEmpty)) ...[
            Divider(
              height: 1,
              color: Theme.of(context).dividerColor.withValues(alpha: 0.3),
            ),
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (record.vehicleDescription != null &&
                      record.vehicleDescription!.isNotEmpty) ...[
                    Container(
                  ...
                  if (record.hasHelmet && record.helmets.isNotEmpty) ...[
                    ...
                    ...record.helmets.asMap().entries.map(
                      (e) => Container(
