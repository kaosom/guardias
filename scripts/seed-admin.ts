 ...
 * Ejecutar desde app: npm run seed-admin
 * Requiere: .env.local con MYSQL_*; tabla guards ya creada (schema.sql).
 */
...
const ADMIN_EMAIL = "admin@buap.com"
const ADMIN_NAME = "Administrador"
const PLAIN_PASSWORD = "Admin!234"
